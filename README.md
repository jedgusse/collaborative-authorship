...
Furthermore, I want to thank the Ghent University Special Research Fund (BOF), the Research Foundation Flanders (FWO), the Henri Pirenne Institute for Medieval Studies at Ghent University, the CLiPS Computational Linguistics Group at the University of Antwerp, and the *Centre Traditio Litterarum Occidentalium* division for computer-assisted research into Latin language and literature housed in the *Corpus Christianorum Library and Knowledge Centre* of Brepols Publishers in Turnhout (Belgium).